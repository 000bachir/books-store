...
<header class="relative h-18 w-full border-b-[1px] border-gray-900 dark:border-gray-400">
	<nav class="relative mx-auto grid h-full w-[95%] grid-cols-4">
		<!--* --logo websites-->
		<div id="logo-website" class="col-span-1 flex h-full items-center">
		...
		<div
			id="links-website"
			class="relative col-span-2 flex h-full w-full items-center justify-center"
		>
			<ul class="relative flex w-full items-center justify-around">
				<li class="">
					...
					<a href="/" class="flex items-center gap-2">
						<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 48 48">
							<path
								...
								d="M10.5 33.184c.548 1.258 1.476 1.727 2.909 1.727h1.983c1.845 0 3.724-1.764 4.198-3.94h0c.473-2.175-.64-3.939-2.486-3.939h-2.19c-1.846 0-2.958-1.763-2.485-3.939h0c.473-2.175 2.352-3.939 4.198-3.939h1.983c1.433 0 2.36.47 2.909 1.727m-7.65 15.993l4.282-19.696m14.108 18.049L37.5 11.126m-3.079 14.16c.724-3.327-1.07-6.025-4.009-6.025h0c-2.937 0-5.906 2.698-6.63 6.025l-.85 3.917c-.724 3.327 1.07 6.024 4.009 6.024h0c2.938 0 5.905-2.697 6.629-6.024"
								stroke-width="1"
							/>
							<rect
								width="37"
					...
					<a href="/" class="flex items-center gap-2">
						<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
							...
							>
								...
								/>
								<path
									d="M12.79 13.12a4.12 4.12 0 1 0 8.24 0a4.12 4.12 0 0 0-8.24 0m3.99 5.63v4.5"
								/>
		...
		<div
			id="user-website"
			class="relative col-span-1 flex h-full w-full items-center justify-center gap-4"
		>
			<ToggleMode />
			<Button
				class="md:hidden lg:hidden xl:hidden 2xl:hidden "
				size={'icon'}
				variant={'link'}
	...
	<!--? --side navigation-->
	{#if SideBarOpen}
		<article class="bg-side-bar absolute top-0 left-0 grid h-dvh w-full grid-rows-4">
			<!--!logo and close navigation-->
			<div
				class="relative row-span-1 mx-auto flex h-full w-[95%] items-center justify-between overflow-hidden border-b-[1px] border-gray-900 dark:border-gray-400"
			>
				...
				<div id="icon_for_closing_the_sidebar" class="">
					<Button variant={'link'} size={'icon'} onclick={() => (SideBarOpen = false)}>
						<svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
							<path
								fill="#fff"
								d="m11.9 13.5l2.1-2.1l2.1 2.1l1.4-1.4l-2.1-2.1l2.1-2.1l-1.4-1.4L14 8.6l-2.1-2.1l-1.4 1.4l2.1 2.1l-2.1 2.1zM6 18V2h16v16zm-4 4V6h2v14h14v2z"
							/>
						</svg>
					</Button>
				</div>
			...
			<div class="row-span-2 h-full w-full">
				<ul class="relative mx-auto flex h-full w-[95%] flex-col justify-around">
					<li class="">
						<a href="/" class="flex items-center gap-2">
							<svg
			...
			<div class="row-span-1 h-full w-full">
